...
df6 <- df6 %>% 
  mutate(SAT1 = ifelse(SAT_1 == 1 ~ 1, SAT_1 == 2 ~ 0)) %>%
  mutate(SAT2 = case_when(SAT_2 == 2 ~ 1, SAT_2 == 1 ~ 0)) %>%
  mutate(SAT3 = case_when(SAT_3 == 1 ~ 1, SAT_3 == 2 ~ 0)) %>%
  mutate(SAT4 = case_when(SAT_4 == 1 ~ 1, SAT_4 == 2 ~ 0)) %>%
  mutate(SAT5 = case_when(SAT_5 == 1 ~ 1, SAT_5 == 2 ~ 0)) %>%
  mutate(SAT6 = case_when(SAT_6 == 2 ~ 1, SAT_6 == 1 ~ 0)) %>%
  mutate(SAT7 = case_when(SAT_7 == 1 ~ 1, SAT_7 == 2 ~ 0)) %>%
  mutate(SAT8 = case_when(SAT_8 == 1 ~ 1, SAT_8 == 2 ~ 0)) %>%
  mutate(SAT9 = case_when(SAT_9 == 2 ~ 1, SAT_9 == 1 ~ 0)) %>%
  mutate(SAT10 = case_when(SAT_10 == 1 ~ 1, SAT_10 == 2 ~ 0))
...
df7 <- df7 %>% 
  ...
  mutate(med = case_when(Group == 1 ~ 'Paper', Media == 2 ~ 'iPad')) %>% 
